...
const SubHeader = ({ updateCountry }) => {
    ...
    return (
        <div className='py-2 w-[90%] sm:flex sm:justify-between my-2 sm:w-4/5 mx-auto'>
            ...
            <select name="region" id="region" onClick={(e) => { updateCountry(e.target.value); e.stopPropagation() }} className='w-3/5 sm:w-1/5 p-2 rounded-sm outline-none mt-2  sm:mt-0'>
